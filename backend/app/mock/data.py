...
def mock_catalog():
    ...
    store=[{"Store_ID":"mock-store","Store_Name":"متجر سلة التجريبي","Store_URL":"https://demo.invalid/","Currency":"SAR","Language":"ar","Extraction_Date":datetime.now(timezone.utc).isoformat(),"Data_Mode":"MOCK","Extractor_Version":"1.8.0"}]
...
def mock_website_data():
    ...
    store = [{"Store_ID":"mock-website","Store_Name":"متجر سلة التجريبي","Store_URL":"https://demo.invalid/","Currency":"SAR","Language":"ar","Extraction_Date":extracted_at,"Data_Mode":"MOCK","Extractor_Version":"1.8.0"}]
    values = {
