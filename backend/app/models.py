...
class Session(BaseModel):
    id:str; stage:Stage; mode:Mode|None=None; data_type:Literal["PRODUCTS","WEBSITE"]="PRODUCTS"; extraction_mode:Literal["QUICK","FULL"]="QUICK"; max_products:int|None=None; message:str; progress_current:int=0; progress_total:int|None=None; progress_percentage:float=0
